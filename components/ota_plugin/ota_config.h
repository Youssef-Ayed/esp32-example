...
#define OTA_SERVER_BASE_URL "http://192.168.0.83:5000/api" // Backend server URL
...
#define DEVICE_ID "esp32_device_001"  // This can be generated or flashed
#define FIRMWARE_REF "1.0.2" // Current firmware reference, can be updated dynamically
